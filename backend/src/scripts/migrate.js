  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS college_details (
        ...
        description TEXT,
        type VARCHAR(50), -- Private, Government, Semi-Government
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS fees (
        ...
        course_type VARCHAR(50), -- UG, PG, Diploma
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS courses (
        ...
        degree_type VARCHAR(50), -- Bachelor, Master, Diploma
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS placements (
        ...
        placement_rate DECIMAL(5, 2), -- percentage
        total_offers INT,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
      );
